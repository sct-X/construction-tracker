 ...
 * selected value. Partner and admin only; builder and site job pages are
 * unchanged. Today is Thu 17 Sep 2026.
 */
...
test.describe('Job switcher', () => {
  ...
  test('builder and site job pages have no switcher', async ({ page }) => {
