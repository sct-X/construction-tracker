...
export const seaviewItems: Item[] = [
  ...
  item({ id: 'it-sv-concreter', job: J, type: 'trade', title: 'Book concreter for pour', waitingOn: 'IR Formwork Constructions', trade: 'tr-ir', owner: P.raff, step: 'sv-pour', requirement: 'sv-rq-concreter', lead: 2, status: 'booked', expected: '2026-10-02', created: '2026-08-24' }),
  ...
  item({ id: 'it-sv-frame-timber', job: J, type: 'material', title: 'Order frame timber', waitingOn: 'Australian Timber Supplies', owner: P.raff, step: 'sv-frame', requirement: 'sv-rq-frame-timber', lead: 4, status: 'booked', expected: '2026-10-01', created: '2026-08-24' }),
  item({ id: 'it-sv-carpenter', job: J, type: 'trade', title: 'Book frame carpenter', waitingOn: 'Build Solid Carpentry', trade: 'tr-buildsolid', owner: P.raff, step: 'sv-frame', requirement: 'sv-rq-carpenter', lead: 3, status: 'confirmed', expected: '2026-10-05', confirmed: '2026-09-11', created: '2026-08-24' }),
  item({ id: 'it-sv-s73', job: J, type: 'condition_of_consent', title: 'Sydney Water section 73 certificate before OC', waitingOn: 'Sydney Water', owner: P.dominic, step: 'sv-handover', lead: 8, status: 'booked', expected: '2027-06-30', created: '2026-08-07', notes: 'Case 236544 lodged 7 Aug through Billbergia.' }),
